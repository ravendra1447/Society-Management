...
export default function Sidebar({ isOpen, setIsOpen }) {
  ...
  const menuItems = [
    ...
    { icon: '📄', label: 'Society Documents', path: '/modules/documents', module: 'documents' },
        { icon: '📦', label: 'Inventory Management', path: '/modules/inventory', module: 'inventory' },
    { icon: '🏢', label: 'Vendor Management', path: '/modules/vendors', module: 'vendors' },
    { icon: '💵', label: 'TDS Summary', path: '/modules/tds', module: 'tds' },
    { icon: '💳', label: 'Salary Management', path: '/modules/salary', module: 'salary' },
    { icon: '🛡️', label: 'Security Logs', path: '/modules/security', module: 'security' },
    { icon: '🔧', label: 'Maintenance Requests', path: '/modules/maintenance', module: 'maintenance' },
    { icon: '🅿️', label: 'Parking Management', path: '/modules/parking', module: 'parking' },
    { icon: '🎉', label: 'Event Management', path: '/modules/events', module: 'events' },
